...
const LatestJobCards = ({ job }) => {
  ...
  return (
    <div    onClick={ () => navigate(`description/${job._id}`)}                className="shadow-xl bg-white border border-gray-100 cursor-pointer p-5 rounded-md hover:shadow-2xl transition">
